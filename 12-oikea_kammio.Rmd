...
Tässä kappaleessa tarkastellaan oikean kammion (RV) läpimitan ja systolisen funktion määrittämistä.

## TAPSE

Edellä kappaleessa 6.5 opetettiin vasemman kammion basaalisen ejektiofraktion mittaaminen M-moodilla. Kyseisessä mittaustavassa hyödynnetään yksinkertaistusta, jonka mukaan ***vasen kammio supistuu ennen kaikkea vaakasuunnassa***.
