...
(ref:diastoliikkapw) Mitraalisisäänvirtauksen mittaus nelilokerokuvasta.

```{r diastoliikkapw, out.width = '100%', echo=FALSE, fig.cap="(ref:diastoliikkapw)"}
 knitr::include_graphics("images/diastoliikka_ea_aallot2.png")
```
...
(ref:diastoliikkatdi) Kudosdopplerilla tehtävä mittaus diastoliikan arvioinnissa. Huomaa sinipunainen kuva, joka nähdään aktivoituneen kudosdopplerin osoituksena.
...
Jos E/Lat E' on yli 13, tulos on poikkeava ja viitteellinen suurentuneelle vasemman kammion täyttöpaineelle (diastoliselle vialle).
