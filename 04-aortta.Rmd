...
Mittaus suoritetaan kätevimmin UKG-laitteen 2D-kuvasta **Caliper-painikkeella** PSLAX-projektiossa. Lisäksi tarvitset hiiren vasenta painiketta sekä Print-painiketta (Fig. \@ref(fig:caliper)).
...
```{r aortantyvi, out.width = '100%', echo=FALSE, fig.cap="(ref:aortantyvi)"}
 knitr::include_graphics("images/aortan_tyvi_end_diastolic.jpg")
```
...
Alan kattojärjestöt [ASE ja EACVI painottavat](https://www.asecho.org/guideline/recommendations-for-cardiac-chamber-quantification-by-echocardiography-in-adults-an-update-from-the-american-society-of-echocardiography-and-the-european-association-of-cardiovascular-imaging/), että ainoastaan aortan annuluksen mittaus suoritetaan keskisystolessa (Fig. \@ref(fig:annulus)), kaikki muut mitat loppudiastolessa (Fig. \@ref(fig:stj)). (Tosin aortan kaaren mittauksesta en ole löytänyt/lukenut näiden kattojärjestöjen suosituksia, joten en ole kiinnittänyt systole vs. diastole -kysymykseen suurta huomiota tuossa.)

<br />
<br />

Table: Aortasta UKG:lla tyypillisesti mitattavia dimensioita.
...
Aortan annulus                          Keskisystole        Esim. TAVI-leikattavat
  ...
  Sinotubulaarijunktio                  Loppudiastole       Vähintään silloin jos aortan dilataatio
  Nouseva tubulaarinen aortta           Loppudiastole       Vähintään silloin jos aortan dilataatio
...
```{r lyhenteita, tidy=FALSE, echo=FALSE, warning=FALSE, message=FALSE}
# library(tidyverse)
# library(kableExtra)
# 
# tibble::tribble(
...
# "Aortan annulus", "Keskisystole", "Esim. TAVI-leikattavat",
# "Aortan tyvi", "Loppudiastole", "**Aina**",
# "STJ", "Loppudiastole", "Vähintään jos aortan dilataatio",
# "ATA", "Loppudiastole", "Vähintään jos aortan dilataatio",
# "Aortan kaari", "(ei ohjeistusta)", "Vähintään jos aortan dilataatio"
#    ) -> aorttataulukko
# 
# 
# knitr::kable((aorttataulukko), booktabs = TRUE,
...
# #   footnote(general = "This is footnote.")
# 
# knitr::kable((data), booktabs = TRUE,
# caption = 'Yleisimpiä UKG-lausunnossa esiintyviä lyhenteitä.') %>%
# footnote(
...
# # kable(data, caption = "Table 1: Information about individuals") %>%
# #   kable_styling() %>%
# #   footnote(general = "This is a footnote about the data.")
...
```{r stj, out.width = '100%', echo=FALSE, fig.cap="(ref:stj)"}
 knitr::include_graphics("images/aortta_stj_tub.jpg")
```
<br />
...
```{r annulus, out.width = '100%', echo=FALSE, fig.cap="(ref:annulus)"}
 knitr::include_graphics("images/aortan_tyvi_annulus.jpg")
```
<br />


[ASEn ja EACVI:n mukaan](https://www.asecho.org/guideline/recommendations-for-cardiac-chamber-quantification-by-echocardiography-in-adults-an-update-from-the-american-society-of-echocardiography-and-the-european-association-of-cardiovascular-imaging/) aortan mitat tulisi ilmaista ns. *leading edge-to-leading edge* -periaatteella. Selkeyden vuoksi tässä katsauksessa kuitenkin esitetään kaikki 2D-kuvasta tehtävät läpimittamittaukset *inner edge-to-inner edge* -periaatteella. Rajaan näiden periaatteiden käsittelyn tämän lyhyen katsauksen ulkopuolelle. Voit halutessasi lukea asiasta lisää esim. [Oxborough'n ja kollegoiden artikkelista](https://www.researchgate.net/publication/262142708_Impact_of_Methodology_and_the_use_of_Allometric_Scaling_on_the_Echocardiographic_Assessment_of_the_Aortic_Root_and_Arch_A_Study_by_the_Research_and_Audit_Sub-Committee_of_the_British_Society_of_Echoca).
