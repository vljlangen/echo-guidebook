...
## Lyhenteet ja mittayksiköt
Seuraavassa taulukossa näytetään UKG:ssa käytettävien lyhenteiden ohella myös eri mittauksille ne mittayksiköt, joita kokemuksestani Turun seudulla tyypillisimmin käytetään. Listan lopussa on myös muutamia sellaisia UKG-löydöksiä, joita saatetaan kuvata lausunnossa lyhentein.
