...
Tästä projektiosta pystyy skannaamaan koko vasemman kammion läpi tilttaamalla (ei siis rotatoimalla!) anturia joko kohti aorttaa (ääriasennossa näkyy poikkileikkaus aorttaläpästä) tai kohti sydämen kärkeä (jolloin näkyy vain vasemman kammion kärki pienen pienenä donitsina).
